...
function AppViewModel() {
	...
	map = new google.maps.Map(document.getElementById('map'), {
			zoom: 6,
			center: {lat:27.371003, lng:78.7906393 }
	});

	// Foursquare API settings
	clientID = "R1WNXLDHVKH4OUVEYSFLODZLE5JIALIMV2X2GHCZL51K01I3";
	clientSecret = "LL3HQDMTPMAUNNS4ZBYATY1UANJIBPP111EXJHWAUHTJV3AS";
